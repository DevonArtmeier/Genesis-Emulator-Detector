...
;
;	Special thanks to Matt Philips (BigEvilCorporation) for the
...
DetectEmulator:
	...
	beq.w	.FoundBlastEm		; If so, then an old version of BlastEm has been detected
